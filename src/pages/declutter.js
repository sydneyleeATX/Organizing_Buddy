...
export default function Declutter() {
  ...
  const handleNextStep = () => {
    ...
    setStepChecked(zoneName, 'declutter', true);
    ...
    return (
      <Layout showTimeline={true} currentStep="declutter">
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1rem' }}>
          <h1 style={{ fontSize: '2rem', color: '#333', marginBottom: '1rem' }}>Sort & Declutter</h1>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', marginBottom: '2rem' }}>
          ...
          <div style={{ minWidth: 0, maxWidth: 400, width: '100%' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem', width: '100%' }}>
              <div style={{ background: '#f0f2f5', borderRadius: '10px', padding: '1rem', boxShadow: '0 2px 8px rgba(0,0,0,0.04)', border: '1px solid #b7e4c7' }}>
              ...
              <div style={{ background: '#f0f2f5', borderRadius: '10px', padding: '1rem', boxShadow: '0 2px 8px rgba(0,0,0,0.04)', border: '1px solid #f5c6cb' }}>
              ...
              <div style={{ background: '#f0f2f5', borderRadius: '10px', padding: '1rem', boxShadow: '0 2px 8px rgba(0,0,0,0.04)', border: '1px solid #bee5eb' }}>
